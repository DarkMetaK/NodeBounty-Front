      ...
      <div className={`mt-4 ${styles.mainContainer}`}>
        <button
          className={`${styles.leftButton} ${
            activeComponent === 'Withdraw' ? styles.activeButton : ''
          }`}
        ...
        <button
          className={`${styles.centerButton} ${
            activeComponent === 'Deposit' ? styles.activeButton : ''
          }`}
        ...
        <button
          className={`${styles.rightButton} ${
            activeComponent === 'Transfer' ? styles.activeButton : ''
          }`}
        ...
        <br />
        <button
          className={`mt-1 ${styles.largeButton} ${
            activeComponent === 'Extract' ? styles.activeButton : ''
          }`}
